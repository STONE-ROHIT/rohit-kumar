/*=============== HOME SPLIT TEXT ===============*/
const { animate, TextSplitter, stagger } = anime; 

const { chars: chars1 } = new TextSplitter('.home__profession-1', { chars: true });
const { chars: chars2 } = new TextSplitter('.home__profession-2', { chars: true });
...
tabs.forEach((tab) => {
  tab.addEventListener('click', () => {
    ...
    tabs.forEach((tab) => tab.classList.remove('work-active'))
...
sr.reveal(`.home__social, .home__resume`, {delay: 1500}) 
